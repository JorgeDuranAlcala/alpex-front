...
const FilterMenuAccountDebt = () => {
  ...
  const handleOnChangeSearch = (value: string) => {
    ...
    searchTimeOutRef.current = setTimeout(() => {
      if (value === '') dispatch(deleteInstallmentsFilter('accountDebt'))
      else
        dispatch(
  ...
  return (
    <Box component={'li'} sx={{ padding: '3px 30px', display: 'flex', alignItems: 'center', width: '100%' }}>
      <Input
        placeholder='Search by Account Debt'
...
export default FilterMenuAccountDebt
